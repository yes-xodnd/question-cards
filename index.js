;(function main() {
  ...
  async function pick() {
    ...
    $cardContent.textContent = questions[numbers[numbers.length - 1]]
...
function getQuestions() {
  return [
    ...
    "죽기 전에 도전해보고 싶은 일이 있나요?",

    "어렸을 때 하던 운동이 있나요? 지금 하는 운동은 없나요?",
    
    "지금까지 만난 사람 중 가장 유명한 사람은 누구인가요? 어떻게 만났는지 말해주세요.",
    ...
    "요즘 가장 많이 듣고 있는 음악에 대해 말해주세요",
    "자신이 운동선수라면 입장곡으로 무엇을 선택할 건가요?",
